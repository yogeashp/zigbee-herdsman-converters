...
export const definitions: DefinitionWithExtend[] = [
    ...
    },
    {
        ...
        model: "70E850TY",
        vendor: "SIMON",
        description: "1 Gang Smart Switch (Non-neutral)",
        extend: extend_1g_nn,
    ...
    },
    {
        ...
        model: "70E851TY",
        vendor: "SIMON",
        description: "2 Gang Smart Switch (Non-neutral)",
        extend: extend_2g_nn,
        meta: {disableDefaultResponse: true},
    ...
    },
    {
        ...
        model: "70E852TY",
        vendor: "SIMON",
        description: "3 Gang Smart Switch (Non-neutral)",
        extend: extend_3g_nn,
        meta: {disableDefaultResponse: true},
    ...
    },
    {
        ...
        model: "70E838TY",
        vendor: "SIMON",
        description: "1 Gang Smart Switch (Neutral)",
        extend: extend_1g_n,
        meta: {disableDefaultResponse: true},
        whiteLabel: [{vendor: "SIMON", model: "S2100-1001"}],
    },
    {
        ...
        model: "70E839TY",
        vendor: "SIMON",
        description: "2 Gang Smart Switch (Neutral)",
        extend: extend_2g_n,
        meta: {disableDefaultResponse: true},
        whiteLabel: [{vendor: "SIMON", model: "S2100-1002"}],
    },
    {
        ...
        model: "70E840TY",
        vendor: "SIMON",
        description: "3 Gang Smart Switch (Neutral)",
        extend: extend_3g_n,
        meta: {disableDefaultResponse: true},
        whiteLabel: [{vendor: "SIMON", model: "S2100-1003"}],
    },
    {
        ...
        model: "70E841TY",
        vendor: "SIMON",
        description: "4 Gang Smart Switch (Neutral)",
        extend: extend_4g_n,
        meta: {disableDefaultResponse: true},
